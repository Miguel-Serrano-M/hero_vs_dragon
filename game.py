...
try:
    ...
    hero_max_dmg = int(input("how many dmg does the hero max have?"))
    dragon_max_dmg = int(input("how many dmg does the dragon max have?"))
except ValueError:
...
# here goes the while:
while True:
    dragon_attack = random.randint(1, dragon_max_dmg)  # type: int
